...
const Sidebar = () => {
  const { isSidebarOpen, openCommentsModal, openTippingModal, openAuthorProfileModal } = useUIStore();
    ...
    <div className={`sidebar ${isSidebarOpen ? 'visible' : ''}`}>
      <div className="profile">
        <button
          ...
          data-action="open-author-profile"
          aria-label="Profil autora"
          onClick={openAuthorProfileModal}
        >
          <img src="" alt="Profil" loading="lazy" decoding="async" />
        </button>
      ...
      <button
        className="icon-button commentsButton"
      ...
      <button
        className="icon-button shareButton"
        data-action="share"
        data-translate-title="shareTitle"
        aria-label="Szeruj"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        className="icon-button tipButton"
        data-action="show-tip-jar"
        data-translate-title="tipTitle"
        aria-label="Napiwek"
