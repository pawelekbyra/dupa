  ...
  return (
    <header className="flex h-[var(--topbar-height)] w-full items-center justify-between bg-black px-4 pt-[var(--safe-area-top)] text-white flex-shrink-0">
      ...
      <div className="flex w-1/3 justify-start">
        <Popover.Root>
          <Popover.Trigger asChild>
            <button className="p-2 rounded-full transition-colors bg-transparent hover:bg-gray-800/50">
              <Menu size={24} />
            </button>
          </Popover.Trigger>
          <Popover.Portal>
      ...
      <div className="flex w-1/3 justify-end">
        <button className="relative p-2 rounded-full transition-colors bg-transparent hover:bg-gray-800/50">
          <Bell size={24} />
